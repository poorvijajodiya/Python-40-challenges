...
class Population:
    def __init__(self,simulation):
        self.population = []
        for p in range(simulation.grid_size):
            row =[]
...
WINDOW_WIDTH = 600
WINDOW_HEIGHT = 600
sim_windows = tkinter.Tk()
sim_windows.title("Epidmic Outbreak")
sim_canvas = tkinter.Canvas(sim_windows, width=WINDOW_WIDTH, height=WINDOW_HEIGHT, bg='lightblue')
