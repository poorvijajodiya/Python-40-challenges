...
class Pykemon:
    ...
    def show_stats(self):
        print("Name: {}\nElement Type: {}\nHealth: {}/{}\nSpeed: {}".format(self.name,self.element,self.current_health,self.max_health,self.speed))
...
class Fire(Pykemon):
    ...
    def special_attack(self,enemy):
        print("Pykemon " + self.name + " used " + self.moves[3] + ".")
    ...
    def move_info(self):
        ...
        print("-- " + self.moves[3] + " --")
        print("\tA powerfull fire based attack...")
...
class Water(Pykemon):
    ...
    def move_info(self):
        ...
        print("\tGuaranteed to heal your Pykemon 15 to 25 damage points.")
        print("-- " + self.moves[3] + " --")
        print("\tA powerfull Water based attack...")
...
class Grass(Pykemon):
    ...
    def move_info(self):
        ...
        print("\tGuaranteed to heal your Pykemon 15 to 25 damage points.")
        print("-- " + self.moves[3] + " --")
        print("\tA powerfull Grass based attack...")
